      ...
      <div className = "container-xxl">
        <div className="row">
          ...
          <div className="nav-links col-4 d-flex align-items-center justify-content-between text-center m-auto">
            <Link to = {'/'} className={location.pathname === '/' ? 'active' : 'intactive'} >Home</Link>
            <Link to = {'shop'} className={location.pathname === '/shop' ? 'active' : 'intactive'}>Shop</Link>
            <Link to = {'blog'} className={location.pathname === '/blog' ? 'active' : 'intactive'}>Blog</Link>
            <Link to = {'about'} className={location.pathname === '/about' ? 'active' : 'intactive'}>About</Link>
            <Link to = {'contact'} className={location.pathname === '/contact' ? 'active' : 'intactive'}>Contact</Link>
          </div>
